...
class StudentForm(forms.ModelForm):
    ...
    class Meta:
        model = Student
        fields = ['username', 'password', 'enrollment_id', 'courses', 'semester']
        widgets = {
...
class TeacherStudentForm(forms.ModelForm):
    ...
    class Meta:
        model = Student
        fields = ['enrollment_id', 'semester']  # Removed 'courses' from fields
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        # We don't need the teacher parameter anymore but keep it for compatibility
        kwargs.pop('teacher', None)
        super().__init__(*args, **kwargs)
        # Remove the courses field completely
