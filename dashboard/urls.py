...
urlpatterns = [
    ...
    path('assignments/<int:id>/edit/', views.teacher_edit_assignment, name='edit_assignment'),
    ...
    path('teacher/assignments/<int:id>/edit/', views.teacher_edit_assignment, name='teacher_edit_assignment'),
