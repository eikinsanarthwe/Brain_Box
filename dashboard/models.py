...
# -----------------------------
# Student Progress Model (SINGLE DEFINITION - FIXED)
# -----------------------------
class StudentProgress(models.Model):
    ...
    module = models.ForeignKey(CourseModule, on_delete=models.CASCADE, null=True, blank=True, related_name='progress')  # ADDED module field
    status = models.CharField(max_length=20, choices=PROGRESS_STATUS, default='not_started')
    progress_percentage = models.IntegerField(default=0)
    last_updated = models.DateTimeField(auto_now=True)
    completed_modules = models.ManyToManyField('CourseModule', blank=True, related_name='completed_by')  # FIXED related_name
    notes = models.TextField(blank=True)

    class Meta:
        unique_together = ['student', 'course', 'module']  # UPDATED to include module
